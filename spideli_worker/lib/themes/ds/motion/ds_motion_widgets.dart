...
/// DsAnimatedCounter(value: earnings, format: (v) => amountShow(amount: v.toString()))
/// ```
...
///
/// ```dart
/// DsImage(url: booking.provider.photos.first, heroTag: 'booking-${booking.id}', width: 72, height: 72, radius: DsRadius.md)
/// ```
