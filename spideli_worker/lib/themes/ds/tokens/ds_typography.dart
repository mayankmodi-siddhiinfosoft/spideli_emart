...
/// the `Metropolis` family (declared in pubspec.yaml with one asset per
/// weight: 400 / 500 / 600 / 700 / 800) is selected by weight, and set
/// `height` so lines never clip at large accessibility text scales.
///
/// Legacy code uses per-weight families (`AppColors.medium` =
/// 'Metropolis-Medium', ...); those still work, but DS styles always use
/// [family] + `fontWeight`.
///
