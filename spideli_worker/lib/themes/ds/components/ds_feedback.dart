...
///
/// ```dart
/// DsEmptyState(icon: Icons.work_outline_rounded, title: 'No jobs today'.tr, message: 'New bookings assigned to you will show up here.'.tr, actionLabel: 'Refresh'.tr, onAction: ...)
/// ```
...
///
/// ```dart
/// DsInlineAlert(tone: DsTone.warning, title: 'Documents pending'.tr, message: 'Upload your documents to start receiving jobs.'.tr, actionLabel: 'Upload'.tr, onAction: ...)
/// ```
...
class DsDialog extends StatelessWidget {
  ...
  ///
  /// ```dart
  /// final ok = await DsDialog.confirm(title: 'Cancel this job?'.tr, message: '...'.tr, confirmLabel: 'Cancel job'.tr, destructive: true);
