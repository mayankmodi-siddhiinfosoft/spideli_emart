...
/// the EssentialSans family (declared per weight in pubspec.yaml) is selected
/// by weight, and set `height` so lines
...
abstract final class DsTypography {
  ...
  /// Glanceable numbers while driving (request countdown, ETA, trip fare on
  /// the live trip panel). Readable at arm's length.
...
class DsTextTheme {
  ...
  TextStyle get metricXl => DsTypography.metricXl.copyWith(color: colors.textPrimary);
