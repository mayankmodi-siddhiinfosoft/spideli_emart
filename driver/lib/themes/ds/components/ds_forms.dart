...
///
/// ```dart
/// DsTextField(label: 'Email'.tr, hint: 'you@example.com', controller: c.emailController, keyboardType: TextInputType.emailAddress, prefixIcon: Icons.mail_outline)
...
///
/// ```dart
/// DsFormSection(title: 'Basic info'.tr, icon: Icons.person_outline, children: [DsTextField(...), DsTextField(...)])
/// ```
...
///
/// ```dart
/// DsSearchBar(hint: 'Search trips'.tr, onChanged: c.search, trailing: DsIconButton(icon: Icons.tune, semanticLabel: 'Filters'.tr, onPressed: ...))
/// ```
