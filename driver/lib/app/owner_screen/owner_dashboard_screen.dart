              ...
              child: Padding(
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    DsCard(
                      ...
                      child: Row(
                        children: [
                          ...
                          DsBadge(label: 'Fleet Owner'.tr, tone: DsTone.brand, small: true),
                        ],
                      ),
                    ),
                    ...
                    // Inbox stays hidden (as before); kept outside the group so it
                    // does not leave an empty divider in the card.
                    Visibility(
                      visible: false,
                      child: DsListTile(
