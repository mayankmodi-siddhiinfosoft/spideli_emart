...
class ParcelSmsOutbox {
  ...
  static const String source = 'driver_app';
  ...
  static const List<String> defaultEvents = <String>[
    ParcelTrackingStatus.collected,
    ParcelTrackingStatus.inTransit,
    ParcelTrackingStatus.atDestinationPoint,
    ParcelTrackingStatus.outForDelivery,
    ParcelTrackingStatus.delivered,
    ParcelTrackingStatus.returned,
  ];
  ...
  static const Map<String, String> _templates = <String, String>{
    ParcelTrackingStatus.created: 'A parcel is on its way to you. Tracking number {tracking}.',
    ParcelTrackingStatus.collected: 'Your parcel {tracking} has been collected and is on its way.',
    ParcelTrackingStatus.inTransit: 'Your parcel {tracking} is in transit.',
    ParcelTrackingStatus.arrivedDestination: 'Your parcel {tracking} has arrived in the destination city.',
    ParcelTrackingStatus.atDestinationPoint: 'Your parcel {tracking} is ready for collection at the pickup point.',
    ParcelTrackingStatus.outForDelivery: 'Your parcel {tracking} is out for delivery today.',
    ParcelTrackingStatus.delivered: 'Your parcel {tracking} has been delivered.',
    ParcelTrackingStatus.returned: 'Your parcel {tracking} is on its way back to the sender.',
    ParcelTrackingStatus.cancelled: 'Your parcel {tracking} has been cancelled.',
  };
  ...
  static Future<Map<String, dynamic>> _gatewaySettings() async {
    ...
    try {
      ...
      debugPrint('ParcelSmsOutbox: SMSGateway not read ($e) — no SMS requests will be written');
  ...
  static String? _message(ParcelOrderModel order, String status) {
    ...
    if (status == ParcelTrackingStatus.atDestinationPoint && (order.pickupCode ?? '').trim().isNotEmpty) {
  ...
  static Future<ParcelSmsRequest?> requestFor(ParcelOrderModel order, String status) async {
    try {
      ...
      if (number == null) {
        debugPrint('ParcelSmsOutbox: $tracking / $status not queued — the receiver phone cannot be normalised to a country code and digits');
        return null;
      }
      ...
      debugPrint('ParcelSmsOutbox: request not built ($e)');
      return null;
    }
  }
