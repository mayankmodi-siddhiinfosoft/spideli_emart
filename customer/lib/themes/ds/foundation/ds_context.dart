...
/// final s = context.dsSection;   // active service section
/// ```
extension DsContextX on BuildContext {
  ...
  /// Active service section (food, ecommerce, cab, parcel, rental, onDemand).
  DsSection get dsSection => DsSection.current;
}
