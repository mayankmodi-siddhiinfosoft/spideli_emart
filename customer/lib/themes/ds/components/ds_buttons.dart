  ...
  Widget build(BuildContext context) {
    ...
    switch (variant) {
      case DsButtonVariant.primary:
        bg = color ?? c.brand;
        fg = color != null ? DsColors.onColor(color!) : c.onBrand;
      ...
      case DsButtonVariant.tonal:
        ...
        fg = color != null ? DsColors.readableOn(color!, bg) : c.brandStrong;
      case DsButtonVariant.ghost:
        bg = Colors.transparent;
        fg = color != null ? DsColors.readableOn(color!, c.surface) : c.brandStrong;
