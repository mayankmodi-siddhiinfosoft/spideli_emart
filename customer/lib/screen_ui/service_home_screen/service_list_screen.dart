        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: Column(
              ...
              children: [
                Text("spideli".tr, style: AppThemeData.semiBoldTextStyle(fontSize: 22, color: themeController.isDark.value ? AppThemeData.grey50 : AppThemeData.grey900)),
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          const Spacer(),
                                          NetworkImageWidget(imageUrl: section.sectionImage ?? '', width: 80, height: 60, fit: BoxFit.contain, showShimmer: false),
                                        ],
                                      ),
                                    ),
                                  );
          ...
          SizedBox(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                return ClipRRect(
                  borderRadius: BorderRadius.circular(12),
                  child: SizedBox(width: MediaQuery.of(context).size.width * 0.8, child: NetworkImageWidget(imageUrl: bannerList[index].toString(), fit: BoxFit.fill, showShimmer: false)),
                );
              },
            ),
          ),
