...
///
/// ```dart
/// DsStatTile(icon: Icons.receipt_long_rounded, label: 'Total bookings'.tr, value: '${c.totalBookings.value}', tone: DsTone.info)
/// DsStatTile(label: 'Earnings'.tr, countTo: earnings, format: (v) => amountShow(amount: '$v'), delta: '+12%', deltaPositive: true)
/// ```
