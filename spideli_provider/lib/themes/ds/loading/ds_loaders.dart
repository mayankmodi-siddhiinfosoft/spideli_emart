...
///
/// `loader()` (lib/constant/constants.dart) already returns a centered DsBrandLoader.
///
/// ```dart
/// const DsBrandLoader()
/// DsBrandLoader(size: 72, label: 'Processing payment'.tr, logo: Image.asset('assets/images/app_logo.png'))
/// ```
