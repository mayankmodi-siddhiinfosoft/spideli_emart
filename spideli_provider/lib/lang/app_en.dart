const Map<String, String> enUS = {
  ...
  'close': 'close',
  'settings': 'settings',
  "Oops! The selected section doesn't have a subscription plan. Please contact the admin.": "Oops! The selected section doesn't have a subscription plan. Please contact the admin.",
  ...
  "admin commission will be charged from customer billing booking and the admin charge will be earned after the booking is accepted by the provider.":
      "admin commission will be charged from customer billing booking and the admin charge will be earned after the booking is accepted by the provider.",
  "admin commission will be charged from your account after the booking is accepted.": "admin commission will be charged from your account after the booking is accepted.",
  "Chat feature is disabled due to subscription limit. Please upgrade to continue.": "Chat feature is disabled due to subscription limit. Please upgrade to continue.",
