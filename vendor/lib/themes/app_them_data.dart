...
class AppThemeData {
  ...
  static TextStyle regularTextStyle({double? fontSize, Color? color, TextDecoration? decoration, Color? decorationColor, TextDecorationStyle? decorationStyle, double? decorationThickness}) {
    return TextStyle(
  ...
  static TextStyle mediumTextStyle({double? fontSize, Color? color, TextDecoration? decoration, Color? decorationColor, TextDecorationStyle? decorationStyle, double? decorationThickness}) {
    return TextStyle(
      fontSize: fontSize ?? 14,
      color: color ?? grey900,
      fontFamily: fontFamily,
  ...
  static TextStyle semiBoldTextStyle({double? fontSize, Color? color, TextDecoration? decoration, Color? decorationColor, TextDecorationStyle? decorationStyle, double? decorationThickness}) {
    return TextStyle(
      fontSize: fontSize ?? 14,
      color: color ?? grey900,
      fontFamily: fontFamily,
  ...
  static TextStyle boldTextStyle({double? fontSize, Color? color, TextDecoration? decoration, Color? decorationColor, TextDecorationStyle? decorationStyle, double? decorationThickness}) {
    return TextStyle(
