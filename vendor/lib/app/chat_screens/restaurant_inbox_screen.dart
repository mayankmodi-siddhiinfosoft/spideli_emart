  ...
  Widget build(BuildContext context) {
    return DsScaffold(
      ...
      body: FirestorePagination(
              ...
              if (!snapshot.hasData || snapshot.hasError || snapshot.connectionState == ConnectionState.waiting) {
                ...
                return DsFadeSlideIn(
                  ...
                  child: _ConversationRow(
                    ...
                    avatar: DsAvatar(imageUrl: customer?.profilePictureURL, name: customer?.fullName(), size: 52),
        ...
        initialLoader: const DsSkeletonList(carded: false, itemCount: 8),
...
/// Messenger-style conversation row: avatar, name + date, one meta line.
                ...
                Expanded(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      border: showDivider ? Border(bottom: BorderSide(color: c.divider)) : null,
                    ),
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(name, maxLines: 1, overflow: TextOverflow.ellipsis, style: t.titleSm.withColor(c.textPrimary)),
                            ),
                        ...
                        Row(
                          children: [
                            Icon(subtitleIcon, size: 16, color: c.textMuted),
                            const DsGap(DsSpace.xs),
                            Expanded(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [DsSkeleton.line(width: 140), const DsGap(DsSpace.sm), DsSkeleton.line(width: 90)],
              ),
            ),
          ],
        ),
