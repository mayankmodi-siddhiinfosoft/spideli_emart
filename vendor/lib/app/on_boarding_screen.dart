                          ...
                          children: [
                                  ...
                                  return SingleChildScrollView(
                                    child: Column(
                                      children: [
                                        Text(
                                          item.title ?? '',
                                          style: AppThemeData.boldTextStyle(color: AppThemeData.primary300),
                            ...
                            controller.currentPage.value == pageCount - 1
                                ...
                                : Row(
                                    children: [
                                      Expanded(
                                        child: RoundedButtonFill(title: "Skip".tr, onPress: () => _finish(), color: AppThemeData.grey50, textColor: AppThemeData.primary300),
                                      ),
