...
import 'package:vendor/widget/osm_map/map_controller.dart';
            ...
            () => FlutterMap(
              ...
              children: [
                TileLayer(
                  ...
                  userAgentPackageName: 'com.spideli.store', // use your app package name
                ),
                MarkerLayer(
              ...
              children: [
                Material(
                  ...
                  child: TextField(
                    ...
                    style: TextStyle(color: AppThemeData.grey900),
                    decoration: InputDecoration(hintText: 'Search location...'.tr, contentPadding: EdgeInsets.all(12), border: InputBorder.none, prefixIcon: Icon(Icons.search)),
